...
//}}}
//{{{
int sofMarker (BYTE* ptr, int width, int height) {
...
//}}}
//{{{
int quantizationTableMarker (BYTE* ptr, int qscale) {
...
//}}}
//{{{
int huffmanTableMarkerDC (BYTE* ptr, unsigned int* htable, int class_id) {
...
//}}}
//{{{
int huffmanTableMarkerAC (BYTE* ptr, unsigned int* htable, int class_id) {
...
//{{{
int driMarker (BYTE* ptr, int restartInterval) {
